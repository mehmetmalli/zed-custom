...
use gpui::{
    Action, AnyElement, Anchor, App, Context, Element, Entity, Focusable, InteractiveElement,
...
impl TitleBar {
    ...
    fn window_activation_changed(&mut self, window: &mut Window, _cx: &mut Context<Self>) {
        self.workspace
